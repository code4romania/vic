...
export const Stepper = ({ steps, currentStep, completedSteps, goToStep }: StepperProps) => {
  return (
    <div className="bg-white border-1 order-cool-gray-30 shadow-sm flex flex-row rounded py-3 px-10 justify-between items-center">
      {steps.map((step, index) => {
        ...
        return (
          <div
            ...
            className={`flex flex-row gap-2 items-center justify-center ${isCompleted ? 'hover:cursor-pointer' : 'cursor-not-allowed'}`}
          >
            <div
