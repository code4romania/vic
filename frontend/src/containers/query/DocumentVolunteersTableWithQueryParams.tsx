...
export type DocumentVolunteersProps = IHOCQueryProps<VolunteersQueryProps> & {
...
const DocumentVolunteersTableWithQueryParams = ({ selectedVolunteers, setSelectedVolunteers }: { selectedVolunteers: IVolunteer[], setSelectedVolunteers: (volunteers: IVolunteer[]) => void }) => {
    ...
    return (
        <QueryParams config={queryConfig}>
            {(props: any) => {
                return <DocumentVolunteersTable {...props} selectedVolunteers={selectedVolunteers} setSelectedVolunteers={setSelectedVolunteers} />;
            }}
        </QueryParams>
    );
};
