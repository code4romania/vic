    ...
    image_repository {
      image_configuration {
        runtime_environment_variables = {
          ...
          ONG_HUB_API    = "https://onghub-api.wearetribus.com/"
          ...
          COGNITO_REGION_WEB       = "eu-central-1"
          COGNITO_CLIENT_ID_WEB    = "6t6smhu23khucipd6d7kn8brbl"
          COGNITO_USER_POOL_ID_WEB = "eu-central-1_tyLzpvQsq"
